...
export class SyncDataController {
  ...
  //   const where: any = {};
  //   if (since) where.modifiedDate = { gte: since };

  //   const createdFrom = this.parseModifiedFrom(createdDateFrom);
  //   const createdTo = this.parseModifiedFrom(createdDateTo);
  //   if (createdFrom || createdTo) {
  //     where.createdDate = {};
  //     if (createdFrom) where.createdDate.gte = createdFrom;
  //     if (createdTo) where.createdDate.lte = createdTo;
  //   }
  ...
  //       where,
  //       include: { inventories: true, images: true, formulas: true },
  //       skip,
  //       take,
  //       orderBy: { id: 'asc' },
  //     }),
  ...
  //       productKiotVietId: f.productKiotVietId?.toString(),
  //     })),
  //   }));
  ...
  //           : null,
  //     })),
  //     formulas: product.formulas.map((f) => ({
  //       ...f,
  //       materialId: f.materialId?.toString(),
  //       productKiotVietId: f.productKiotVietId?.toString(),
  //     })),
  ...
  //   const { skip, take } = this.parsePagination({ pageSize, currentItem });
  //   const since = this.parseModifiedFrom(modifiedFrom);
  //   const purchaseTo = this.parseModifiedFrom(purchaseDateTo);

  //   const where: any = {};
  //   if (since) where.modifiedDate = { gte: since };
  //   if (purchaseTo) where.purchaseDate = { lte: purchaseTo };
  ...
  //   const purchaseFrom = this.parseModifiedFrom(purchaseDateFrom);
  //   const purchaseTo = this.parseModifiedFrom(purchaseDateTo);

  //   // Ưu tiên lọc theo khoảng purchaseDate [from, to] nếu được truyền,
  //   // ngược lại giữ behavior cũ: modifiedFrom → purchaseDate >= since.
  //   const where: any = {};
  //   if (purchaseFrom || purchaseTo) {
  //     where.purchaseDate = {};
  //     if (purchaseFrom) where.purchaseDate.gte = purchaseFrom;
  //     if (purchaseTo) where.purchaseDate.lte = purchaseTo;
  //   } else if (since) {
  ...
  // async getCashflows(
  //   @Query('modifiedFrom') modifiedFrom?: string,
  //   @Query('transDateFrom') transDateFrom?: string,
  //   @Query('transDateTo') transDateTo?: string,
  //   @Query('pageSize') pageSize?: string,
  //   @Query('currentItem') currentItem?: string,
  // ) {
  //   const { skip, take } = this.parsePagination({ pageSize, currentItem });
  ...
  //   const where: any = {};
  //   if (modifiedFrom) {
  //     where.lastSyncedAt = { gte: new Date(modifiedFrom) };
  //   }

  //   const transFrom = this.parseModifiedFrom(transDateFrom);
  //   const transTo = this.parseModifiedFrom(transDateTo);
  //   if (transFrom || transTo) {
  //     where.transDate = {};
  //     if (transFrom) where.transDate.gte = transFrom;
  //     if (transTo) where.transDate.lte = transTo;
  //   }
  ...
  //     branchKiotVietId: po.branch?.kiotVietId ?? null,
  //     branch: undefined,
  //   }));
  ...
  //     branchKiotVietId: os.branch?.kiotVietId ?? null,
  //     branch: undefined,
  //   }));
