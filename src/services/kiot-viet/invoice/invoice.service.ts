      ...
      try {
        ...
        const invoice = await this.prismaService.invoice.upsert({
          ...
          update: {
            ...
            totalPayment: new Prisma.Decimal(invoiceData.totalPayment),
          ...
          create: {
            ...
            total: invoiceData.total
              ? new Prisma.Decimal(invoiceData.total)
              : 0,
            totalPayment: invoiceData.totalPayment
              ? new Prisma.Decimal(invoiceData.totalPayment)
              : 0,
            discount: invoiceData.discount
              ? new Prisma.Decimal(invoiceData.discount)
              : 0,
